...
interface ContactsLocalRepository {
    suspend fun addContact(contact: ContactInfo): Result<Unit, DataError.NetworkError>
    suspend fun addContacts(contacts: List<ContactInfo>): Result<Unit, DataError.NetworkError>
